...
<body>
    ...
    <section class="border-bottom border-3 border-primary">
      ...
      <div class="pt-5">
        <div class="container d-flex flex-column align-items-center py-5">
          ...
          <form class="d-flex w-75" action="">
            <div class="input-group">
              <select class="form-select custom-input bg-white text-primary">
            ...
            <button class="btn btn-primary rounded-0 px-5">Rechercher</button>
          </form>
          <div class="w-75 row mt-3">
            <div class="col-lg-5">
              <span class="text-muted fw-bold">Casablanca</span>
            </div>
            <div class="col-lg-5">
              <span class="text-muted fw-bold">Traiteur</span>
            </div>
            <div class="col-lg-2">
  ...
  <main>
    ...
    <article class="text-center bg-main py-3">
      ...
      <p class="text-small">
        TROUVEZ LES MEILLEURS POUR VOTRE MARIAGE ET DEMANDEZ-LEUR DES INFORMATIONS SUR LEUR DISPONIBILITÉ ET LEURS PRIX.
      </p>
    </article>
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 col-12 mb-4">
          <a class="text-dark" style="text-decoration: none;" href="#">
            <div class="card p-2 custom-card ">
                <div class="mb-2 d-flex justify-content-center" style="background-color: #5050508a !important;">
                  <img src="https://placehold.co/300x250/8B5B37/FFF" class="img-fluid" alt="...">
                </div>
                  <div class="card-body p-0">
                    <h5 class="mb-0">Nom Traiteur</h5>
                    <div class="d-flex justify-content-between">
                      <span class="text-small">Esthétique - Coiffure</span>
                      <span class="text-small">Casablanca</span>
                    </div>
                  </div>
            </div>
          </a>
