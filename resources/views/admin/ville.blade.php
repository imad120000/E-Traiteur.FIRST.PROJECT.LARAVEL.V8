        ...
        <aside class="dashboard__sidebar">
            ...
            <section class="dashboard__sidebar-nav">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="ps-3 nav-link active" aria-current="page" href="{{ route('admin.ville') }}">
                            <i class="icon ti-announcement"></i>
                            Villes
                        </a>
                    </li>
            ...
            <div class="main__content">
                <div class="container">
                    ...
                    <section class="dashboard__table-de-bord">
                                ...
                                @foreach ($ville as $v)
                                    <tbody>
                                        <tr id="service-1">
                                            ...
                                            <td class="text-center pt-4"> {{ $v->created_at }}</td>
                                            <td class="pt-3">
                        ...
                        @foreach ($ville as $e)
                            <form method="post" action="{{ route('admin.deleteville', $e->id) }}">
                                @csrf
                                @method('DELETE')
                                <div class="modal fade" id="confirmDeleteModal{{ $e->id }}"
                                        ...
                                        <div class="modal-content rounded-0 bg-main border-0">
                                            <div class="modal-header border-0">
                                                <h1 class="modal-title fs-5 text-primary text-center w-100"
                                                    ...
                                                    Confirmer votre action , Lorsque vous supprimez une villes,
                                                    vous supprimez également le client qui a choisi ce ville,
                                                    ainsi que la suppression des publications liées à ce ville ....... ?
                                                    ?
                                                </h1>
                                            </div>
                ...
                <div class="modal fade" id="add-service" data-bs-backdrop="static" data-bs-keyboard="false"
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" style="min-width: 45rem;">
                        <div class="modal-content rounded-0 bg-main border-0">
                            <form method="POST" action="{{route('admin.addville')}}" >
                                @csrf
                                <div class="modal-header border-0">
