              ...
              <div class="row">
                <div class="col-lg-6">
                  <div class="dashboard__table-de-bord-card">
                    ...
                    <div class="dashboard__table-de-bord-card-body">
                      <ul class="list-group">
                        <li class="list-group-item my-list-item">Aujourd'hui <span>{{$today}}</span></li>
                        <li class="list-group-item my-list-item">Hier <span>{{$yesterday}}</span></li>
                        <li class="list-group-item my-list-item">Cette semaine <span>{{$week}}</span></li>
                        <li class="list-group-item my-list-item">Ce mois-ci <span>{{$mounth}}</span></li>
                        <li class="list-group-item my-list-item">Cette année <span>{{$year}}</span></li>
                        <li class="list-group-item my-list-item">Total <span>{{$total_demand}}</span></li>
                      </ul>
                    </div>
                  </div>
                </div>
                <div class="col-lg-6">
                  <div class="dashboard__table-de-bord-card">
                    ...
                    <div class="dashboard__table-de-bord-card-body">
                      <ul class="list-group">
                        <li class="list-group-item my-list-item">Aujourd'hui <span>{{$revenu_today}} MAD</span></li>
                        <li class="list-group-item my-list-item">Hier <span>{{$revenu_yesterday}} MAD</span></li>
                        <li class="list-group-item my-list-item">Cette semaine <span>{{$revenu_thisweek}} MAD</span></li>
                        <li class="list-group-item my-list-item">Ce mois-ci <span>{{$revenu_thismounth}} MAD</span></li>
                        <li class="list-group-item my-list-item">Cette année <span>{{$revenu_thisyear}} MAD</span></li>
                        <li class="list-group-item my-list-item">Total <span>{{$revenu_total}} MAD</span></li>
                      </ul>
                    </div>
                  </div>
                </div>
