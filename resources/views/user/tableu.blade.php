    ...
    <aside class="dashboard__sidebar">
      ...
      <section class="dashboard__sidebar-nav">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="ps-3 nav-link" href="{{route('user.statistiques')}}">
                ...
                <div class="col-12">
                  <div class="dashboard__table-de-bord-card">
                    ...
                    <div class="dashboard__table-de-bord-card-body">
                      <ul class="list-group">
                      <ul class="list-group">
                          <li class="list-group-item my-list-item">Aujourd'hui <span>{{ $todayVisitors }}</span></li>
                          <li class="list-group-item my-list-item">Hier <span>{{ $yesterdayVisitors }}</span></li>
                          <li class="list-group-item my-list-item">Cette semaine <span>{{ $thisWeekVisitors }}</span></li>
                          <li class="list-group-item my-list-item">Ce mois-ci <span>{{ $thisMonthVisitors }}</span></li>
                          <li class="list-group-item my-list-item">Cette année <span>{{ $thisYearVisitors }}</span></li>
                          <li class="list-group-item my-list-item">Total <span>{{ $totalVisitors }}</span></li>
                      </ul>  
                      </ul>
                    </div>
                  </div>
