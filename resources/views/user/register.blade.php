  ...
  <main class="login">
    ...
    <div class="card login__card register">
      <form action="{{route('user.create')}}" enctype="multipart/form-data"  method="POST" >
              ...
              <div class="col-lg-6">
                <div class="px-4">
                  ...
                  <div class="input-group mb-2">
                    ...
                    />
                    <span class="text-danger">@error('NomCommercial'){{ $message }} @enderror</span>
                  ...
                  <div class="input-group fit-content border-0">
                    ...
                    <span class="text-danger">@error('cinDocument1'){{ $message }} @enderror</span>
                  ...
                  <div class="input-group fit-content border-0">
                    <input class="d-none"  type="file" name="statusDocument" id="status-justification">
                    <span class="text-danger">@error('statusDocument'){{ $message }} @enderror</span>
              ...
              <div class="col-lg-6">
                <div class="px-4">
                  ...
                  <div class="input-group mb-2">
                    ...
                    >
                      <option value="1">traiteurs</option>
                      <option value="2">accessoires mariée</option>
                      <option value="3">animation</option>
                      <option value="4">bagues &amp; bi</option>
                      <option value="5">makeup artistes &amp; neggafa</option>
                      <option value="6">caftans &amp; takchita</option>
                      <option value="7">coiffure homme</option>
                      <option value="8">sonorisation &amp; Dj</option>
                      <option value="9">Glaciers</option>
                      <option value="10">henné artistes</option>
                      <option value="11">hôtels de mariage</option>
                      <option value="12">orchestres</option>
                      <option value="13">parfumerie</option>
                      <option value="14">pâtisseries</option>
                  ...
                  <div class="input-group fit-content border-0">
                    ...
                    <span class="text-danger">@error('cinDocument2'){{ $message }} @enderror</span>
                  ...
                  <div class="input-group fit-content border-0">
                    <input class="d-none"  type="file" name="profileDocument" id="profil-justification">
                    <span class="text-danger">@error('profileDocument'){{ $message }} @enderror</span>
        ...
        <p class="text-center text-muted"><strong>Note: </strong>les données avec * sont nècessaires pour s'inscrire à e-traiteur</p>
        <p class="text-center">
