    ...
    <section class="dashboard">
        <aside class="dashboard__sidebar">
            ...
            <section class="dashboard__sidebar-nav">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="ps-3 nav-link active" aria-current="page" href="{{ route('user.services') }}">
        ...
        <main class="dashboard__main">
            ...
            <div class="main__content">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <div class="table__img-container me-2">
                                                            <img class="table__img"
                                                                src="{{ asset('profile/' . $i->user->profileDocument) }}"
                                    ...
                                    <div class="modal-body p-0">
                                        <table class="table table-bordered border-main m-0">
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="3">
                                                    <input type="text" placeholder="Ajouter le lien de votre vidéo"
                                                        class="form-control custom-input" name="video">
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td colspan="3">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <span class="text-small text-muted ms-2">Taille max des photos
                                                            est 50MB</span>
                                                    </div>
                                                </td>
                                            </tr>
                ...
                @if ($annonce->count() > 0)
                    {{-- Desplay info  --}}
                    <div class="modal fade" id="serviceModal" data-bs-backdrop="static" data-bs-keyboard="false"
                        tabindex="-1" aria-labelledby="serviceModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
                            style="min-width: 45rem;">
                            <div class="modal-content rounded-0 bg-main border-0">
                                <form action="">
                                                    ...
                                                    <td colspan="3">
                                                        ...
                                                        @foreach (array_chunk($photos, 2) as $photo_row)
                                                            @foreach ($photo_row as $photo)
                                                                <img class="modal-thumb" width="40px"
                                                                    src="{{ asset('postimage/' . $photo) }}">
                                                            @endforeach
                                                        @endforeach
                                                    </td>
                                                </tr>
                ...
                @if ($annonce->count() > 0)
                    <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel"
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
                            ...
                            <div class="modal-content rounded-0 bg-main border-0">
                                @foreach ($annonce as $i)
                                    <form action="{{ route('user.updatePost', $i->id) }}" method="post"
                                        enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="modal-body p-0">
                                            <table class="table table-bordered border-main m-0">
                                                <tr>
                                                    ...
                                                    <td colspan="3">
                                                        <input type="text" value="{{ $i->title }}"
                                                            class="form-control custom-input" name="title">
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <td class="pt-3"><strong>Lien de video</strong></td>
                                                    <td colspan="3">
                                                        <input type="text" value="{{ $i->video }}"
                                                            name="video" class="form-control custom-input">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="pt-3"><strong>Photos</strong></td>
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            <div class="input-group fit-content">
                                                                <input class="d-none" type="file"
                                                                    id="photosUpload" name="photo[]" multiple>
                                                                <label class="file-input" for="photosUpload">
                                                                    <i class="ti-image me-2"></i> Images à importer
                                                                </label>
                                                            </div>
                                                            <span class="text-small text-muted ms-2">Taille max des
                                                                photos est 2MB</span>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" name="tele"
                                                            value="{{ $i->user->tele }}" placeholder="0600000000"
