...
<body>
  <header>
    ...
    <section class=" border-primary">
      <nav class="navbar bg-primary navbar-expand-lg navbar-dark">
        <div class="container">
          <a href="/" class="navbar-brand fs-3"><img src="../assets/images/Logo wight.png" width="150"> </a>
          ...
          <div class="collapse navbar-collapse" id="navBarCollapsable">
            <ul class="navbar-nav w-100 align-items-center">
              ...
              <li class="nav-item dropdown-center me-0 me-lg-auto">
                <a class="nav-link dropdown-toggle laguange__pref-choise" role="button" href="#" data-bs-toggle="dropdown" aria-expanded="false" id="currentLang" data-lang="fr">
                  <img class="border-white rounded-pill laguange_pref language_icon" src="assets/images/fr.png" alt="fr-flag" >
                </a>
                <ul class="dropdown-menu laguange__pref-dropdown" id="otherLang">
                  <li>
                    <a class="dropdown-item laguange__pref-choise" onclick="langChange(this)" href="#" data-lang="ar">
                      <img class="border-white rounded-pill laguange_pref language_icon" src="assets/images/ar.png" alt="ar-flag">
                    </a>
                  </li>
                  <li>
                    <a class="dropdown-item laguange__pref-choise" onclick="langChange(this)" href="#" data-lang="en">
                      <img class="border-white rounded-pill laguange_pref language_icon" src="assets/images/en.png" alt="en-flag">
                    </a>
                  </li>
                </ul>
              </li>
              <li class="nav-item ms-5">
                <ul class="nav">
                  <li class="nav-item">
                    <a class="nav-link text-white fs-5" href="https://www.facebook.com/profile.php?id=100091686102691">
      ...
      <div class="pt-5">
        <div class="container d-flex flex-column align-items-center py-5">
          <h1 class="text-center fw-bold mb-3 text-primary display-4" data-translate='AboutMainTitle'>Aprops De Nous</h1>
        </div>
      </div>
    </section>
  </header>
  <main>
    <div class="container">
      <p class="mb-3 text-center" data-translate='AboutMainText'>
        Lorem ipsum dolor sit amet consectetur, adipisicing elit. In, laudantium nostrum itaque aspernatur velit accusamus unde id! Nihil minus ratione dolore aperiam praesentium exercitationem nisi.
      </p>
    </div>
  </main>
      ...
      <div class="row align-items-center">
        <div class="col-md-4">
          <ul class="nav flex-column text-center text-md-start">
            ...
            <li class="nav-item">
              <a href="/conditions-utilisateurs" class="nav-link" data-translate='NavConditionUtilization'>Conditions générales
                d'utilisation</a>
            </li>
          </ul>
        </div>
        <div class="col-md-4 d-flex align-items-center justify-content-center">
          <a href="/">
            <img src="/assets/images/Logo wight.png" alt="etraiteur" class="img-fluid" style="max-width: 300px; margin: 25px 0">
          </a>
        </div>
        <div class="col-md-4">
          <div class="d-flex">
            <p class="text-light text-small" data-translate='FooterReseauxSociaux'>Contactez-nous sur nos résaux sociaux ou par messagerie ci-dessous</p>
          ...
          <form id="create-emessage">
            <div class="input-group mb-2">
              <input type="email" class="form-control custom-input bg-white" placeholder="Votre email.." data-translate='EmailAddressPlaceHolder'>
              <button type="submit" class="btn btn-primary rounded-0 ms-2" data-translate='EmailSendBtn'>Envoyer</button>
            </div>
            <textarea class="form-control custom-input bg-white" name="" id="" cols="30" rows="5" placeholder="Votre message.." data-translate='EmailBodyPlaceholder'></textarea>
          </form>
        </div>
      </div>
    </div>
  ...
  <script>
    ...
    var translate= new Translator('/assets/data/pagesTraduction.json', currentLang.getAttribute('data-lang'), 'publicSiteLang');
    translate.init();
    ...
    form.addEventListener("submit", (e) => {
      ...
      fetch('/api/emessages', {
        method: 'POST',
        body: JSON.stringify({ content: content.value, email: email.value }),
